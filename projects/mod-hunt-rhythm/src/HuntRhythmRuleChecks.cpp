...
static_assert(HuntRhythm::AddBonus(1000000000, 10, 0).amount == 1100000000);
static_assert(HuntRhythm::PetAwardSafe(1000000000, 4.0f, 0));
static_assert(!HuntRhythm::PetAwardSafe(1100000000, 4.0f, 0));
static_assert(HuntRhythm::PetAwardSafe(1000, 1.0f, 0xFFFFFFFFu - 1050));
static_assert(!HuntRhythm::PetAwardSafe(1100, 1.0f, 0xFFFFFFFFu - 1050));
static_assert(!HuntRhythm::PetAwardSafe(1000, -1.0f, 0));
static_assert(!HuntRhythm::PetAwardSafe(0xFFFFFFFFu, 1.0f, 0));
